 ...
 */
/* !function(e){"use strict";e.fn.cmsmastersFixedHeaderScroll=function(i){var t={headerTop:".header_top",headerMid:".header_mid",headerBot:".header_bot",navBlock:"nav",navList:"#navigation",navTopList:"#top_line_nav",respNavButton:".responsive_nav",respTopNavButton:".responsive_top_nav",fixedClass:".fixed_header",fixedClassBlock:"#page",respHideBlocks:"",maxWidthMid:1024,maxWidthBot:1024,changeTopHeight:!0,changeMidHeight:!0,mobileDisabled:!0},o=this,a={};a={init:function(){a.options=a.o=e.extend({},t,i),a.el=o,a.vars=a.v={},a.v.newTopHeight=0,a.v.newMidHeight=0,a.v.paddingHeader=0,a.setHeaderVars(),a.startHeader()},setHeaderVars:function(){a.v.headerMidString=a.o.headerMid,a.v.headerTop=a.el.find("> "+a.o.headerTop),a.v.headerMid=a.el.find("> "+a.v.headerMidString),a.v.headerBot=a.el.find("> "+a.o.headerBot),a.v.respNavButton=a.el.find(a.o.respNavButton),a.v.respTopNavButton=a.el.find(a.o.respTopNavButton),a.v.respHideBlocks=e(a.o.respHideBlocks),a.v.navListString=a.o.navList,a.v.navTopListString=a.o.navTopList,a.v.navBlockString=a.o.navBlock,a.v.navBlock=a.el.find(a.v.navListString).parents(a.v.navBlockString),a.v.navTopBlock=a.el.find(a.v.navTopListString).parents(a.v.navBlockString),a.v.midChangeHeightBlocksResp=e(a.v.headerMidString+", "+a.v.headerMidString+" .header_mid_outer, "+a.v.headerMidString+" "+a.v.navListString+", "+a.v.headerMidString+" "+a.v.navListString+" > li, "+a.v.headerMidString+" "+a.v.navListString+" > li > a, "+a.v.headerMidString+" "+a.v.navListString+" > li > a > span.nav_bg_clr"),a.v.topHeight=0,a.v.midHeight=0,a.v.botHeight=0,a.v.win=e(window),a.v.winScrollTop=a.v.win.scrollTop(),a.v.winMidScrollTop=a.v.winScrollTop-a.v.topHeight-a.v.midHeight,a.v.isMobile="ontouchstart"in document.documentElement},startHeader:function(){a.v.headerTop.length>0&&(a.v.topHeight=Number(a.v.headerTop.attr("data-height"))),a.v.headerMid.length>0&&(a.v.midHeight=Number(a.v.headerMid.attr("data-height"))),a.v.headerBot.length>0&&(a.v.botHeight=Number(a.v.headerBot.attr("data-height"))),0==a.v.winScrollTop&&a.el.css({opacity:1}),a.attachEvents(),a.v.win.trigger("scroll")},attachEvents:function(){a.v.respNavButton.bind("click",function(){return a.v.respNavButton.is(":not(.active)")?(a.v.navBlock.css({display:"block"}),a.v.respHideBlocks.css({display:"none"}),a.v.respNavButton.addClass("active")):(a.v.navBlock.css({display:"none"}),a.v.respHideBlocks.css({display:"block"}),a.v.respNavButton.removeClass("active")),!1}),a.v.respTopNavButton.bind("click",function(){return a.v.respTopNavButton.is(":not(.active)")?(a.v.navTopBlock.css({display:"block"}),a.v.respHideBlocks.css({display:"none"}),a.v.respTopNavButton.addClass("active")):(a.v.navTopBlock.css({display:"none"}),a.v.respHideBlocks.css({display:"block"}),a.v.respTopNavButton.removeClass("active")),!1}),a.v.win.bind("scroll",function(){return!a.el.parents(a.o.fixedClassBlock).is(":not("+a.o.fixedClass+")")&&void(cmsmasters_media_width()>a.o.maxWidthMid&&a.getScrollTop())}),a.v.win.bind("resize",function(){a.headerResize(a.v.headerBot.length>0?a.o.maxWidthBot:a.o.maxWidthMid)})},getScrollTop:function(){0==a.v.headerBot.length?(a.v.paddingHeader=a.v.midHeight,a.v.newMidHeight=a.v.midHeight/1.4):(a.v.paddingHeader=a.v.botHeight,a.v.newMidHeight=a.v.midHeight),a.v.winScrollTop=a.v.win.scrollTop(),a.v.winMidScrollTop=a.v.winScrollTop-a.v.topHeight-a.v.midHeight,a.v.winScrollTop>a.v.topHeight+a.v.midHeight+a.v.botHeight?(a.el.css({marginTop:-(a.v.topHeight+a.v.midHeight+a.v.botHeight),paddingTop:a.v.paddingHeader,opacity:1}).addClass("navi_scrolled"),a.v.headerMid.css({height:a.v.newMidHeight})):(a.el.removeClass("navi_scrolled").css({marginTop:-a.v.winScrollTop,paddingTop:0,opacity:1}),a.v.headerMid.css({height:a.v.midHeight}))},headerResize:function(e){return a.el.parents(a.o.fixedClassBlock).is(":not("+a.o.fixedClass+")")?(a.v.navBlock.removeAttr("style"),!1):void(cmsmasters_media_width()>e?(a.v.navBlock.removeAttr("style"),a.v.respHideBlocks.removeAttr("style"),a.v.respNavButton.removeClass("active"),a.getScrollTop()):(a.el.removeAttr("style").removeClass("navi_scrolled").css({opacity:1}),a.v.headerMid.css({height:"auto"})))}},a.init()}}(jQuery); */
! function(e) {
    "use strict";
    e.fn.cmsmastersFixedHeaderScroll = function(i) {
        ...
        a = {
            init: function() {
                a.options = a.o = e.extend({}, t, i), a.el = o, a.vars = a.v = {}, a.v.newTopHeight = 0, a.v.newMidHeight = 0, a.v.paddingHeader = 0, a.setHeaderVars(), a.startHeader()
            },
            setHeaderVars: function() {
                a.v.headerMidString = a.o.headerMid, a.v.headerTop = a.el.find("> " + a.o.headerTop), a.v.headerMid = a.el.find("> " + a.v.headerMidString), a.v.headerBot = a.el.find("> " + a.o.headerBot), a.v.respNavButton = a.el.find(a.o.respNavButton), a.v.respTopNavButton = a.el.find(a.o.respTopNavButton), a.v.respHideBlocks = e(a.o.respHideBlocks), a.v.navListString = a.o.navList, a.v.navTopListString = a.o.navTopList, a.v.navBlockString = a.o.navBlock, a.v.navBlock = a.el.find(a.v.navListString)
                    .parents(a.v.navBlockString), a.v.navTopBlock = a.el.find(a.v.navTopListString)
                    .parents(a.v.navBlockString), a.v.midChangeHeightBlocksResp = e(a.v.headerMidString + ", " + a.v.headerMidString + " .header_mid_outer, " + a.v.headerMidString + " " + a.v.navListString + ", " + a.v.headerMidString + " " + a.v.navListString + " > li, " + a.v.headerMidString + " " + a.v.navListString + " > li > a, " + a.v.headerMidString + " " + a.v.navListString + " > li > a > span.nav_bg_clr"), a.v.topHeight = 0, a.v.midHeight = 0, a.v.botHeight = 0, a.v.win = e(window), a.v.winScrollTop = a.v.win.scrollTop(), a.v.winMidScrollTop = a.v.winScrollTop - a.v.topHeight - a.v.midHeight, a.v.isMobile = "ontouchstart" in document.documentElement
            },
            startHeader: function() {
                a.v.headerTop.length > 0 && (a.v.topHeight = Number(a.v.headerTop.attr("data-height"))), a.v.headerMid.length > 0 && (a.v.midHeight = Number(a.v.headerMid.attr("data-height"))), a.v.headerBot.length > 0 && (a.v.botHeight = Number(a.v.headerBot.attr("data-height"))), 0 == a.v.winScrollTop && a.el.css({
                    opacity: 1
                }), a.attachEvents(), a.v.win.trigger("scroll")
            },
            attachEvents: function() {
                a.v.respNavButton.bind("click", function() {
                    ...
                    return !a.el.parents(a.o.fixedClassBlock)
                        .is(":not(" + a.o.fixedClass + ")") && void(cmsmasters_media_width() > a.o.maxWidthMid && a.getScrollTop())
                }), a.v.win.bind("resize", function() {
                    a.headerResize(a.v.headerBot.length > 0 ? a.o.maxWidthBot : a.o.maxWidthMid)
                })
            },
            getScrollTop: function() {
                0 == a.v.headerBot.length ? (a.v.paddingHeader = a.v.midHeight, a.v.newMidHeight = a.v.midHeight / 1.4) : (a.v.paddingHeader = a.v.botHeight, a.v.newMidHeight = a.v.midHeight), a.v.winScrollTop = a.v.win.scrollTop(), a.v.winMidScrollTop = a.v.winScrollTop - a.v.topHeight - a.v.midHeight, a.v.winScrollTop > a.v.topHeight + a.v.midHeight + a.v.botHeight ? (a.el.css({
                        marginTop: -(a.v.topHeight + a.v.midHeight + a.v.botHeight),
                        paddingTop: a.v.paddingHeader,
                        opacity: 1
                    })
                    .addClass("navi_scrolled"), a.v.headerMid.css({
                        height: a.v.newMidHeight
                    })) : (a.el.removeClass("navi_scrolled")
                    .css({
                        marginTop: -a.v.winScrollTop,
                        paddingTop: 0,
                        opacity: 1
                    }), a.v.headerMid.css({
                        height: a.v.midHeight
                    }))
            },
            headerResize: function(e) {
				return a.el.parents(a.o.fixedClassBlock)
					.is(":not(" + a.o.fixedClass + ")") ? (a.v.navBlock.removeAttr("style"), !1) : void(cmsmasters_media_width() > e ? (a.v.navBlock.removeAttr("style"), a.v.respHideBlocks.removeAttr("style"), a.v.respNavButton.removeClass("active"), a.getScrollTop()) : (a.el.removeAttr("style")
						.removeClass("navi_scrolled")
						.css({
							opacity: 1
						}), a.v.headerMid.css({
							height: "auto"
